    ...
    <a-form :form="form" layout="horizontal">
      <div :class="advanced ? null: 'fold'">
        <template v-for="(im, ix) in columns ">
          <a-row v-show="ix==0" :key="im.dataIndex"
                 :gutter="16">
            <a-col
              v-for="(im2, ix2) in im"
              :key="ix2"
            ...
            >
              <a-form-item :label="im2.title">
                ...
                <a-range-picker v-else-if="im2.formType == `datePicker`" allowClear
                                v-decorator="[im2.dataIndex]" showTime
          ...
          <a-row v-show="ix!=0&&advanced" :key="im.dataIndex"
                 :gutter="16">
            <a-col
              v-for="(im2, ix2) in im"
              :key="ix2"
      ...
      <span
        :style="{position: 'absolute',right:'0',bottom:advanced?'0':'50%',transform: advanced?'translate(0,0)':'translate(0,50%)'  }">
