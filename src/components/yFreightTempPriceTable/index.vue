  ...
  <div style="width: 100%;">
    <div class="y-tools">
      <div class="y-tools-action">
        <a-button type="primary" icon="check-circle" @click="onSubmit">确定</a-button>
      </div>
    </div>
    ...
    <div class="y-tools">
      ...
      <div class="y-tools-action">
        <a-button type="primary" icon="plus" @click="onAddBaoYou">添加</a-button>
      </div>
    </div>
    <div class="y-table">
      <a-table
      ...
      >
        ...
        <div slot="fullPackageNum" slot-scope="text,record">
          <a-input-number v-model="record.fullPackageNum" :min="0" allow-clear/>
        </div>
        <div slot="fullPackagePrice" slot-scope="text,record">
          <a-input-number v-model="record.fullPackagePrice" :min="0.00" :precision="2" allow-clear/>
        </div>
        <a slot="action" slot-scope="text,record">
          <a-button icon="delete" type="danger" @click="onDelBaoYou(record)"></a-button>
        </a>
      </a-table>
    </div>
    <div class="y-tools">
    ...
    <div class="y-table">
      ...
      >
        ...
        <div slot="firstPrice" slot-scope="text,record">
          <a-input-number v-model="record.firstPrice" :min="0.00" :precision="2" allow-clear/>
        </div>
        ...
        <div slot="nextPrice" slot-scope="text,record">
          <a-input-number v-model="record.nextPrice" :min="0.00" :precision="2" allow-clear/>
        </div>
        <div slot="fullPackageNum" slot-scope="text,record">
          <a-input-number v-model="record.fullPackageNum" :min="0" allow-clear/>
        </div>
        ...
        <a slot="action" slot-scope="text,record">
          <a-button icon="delete" type="danger" @click="onDel(record)"></a-button>
        </a>
      </a-table>
    </div>
  </div>
