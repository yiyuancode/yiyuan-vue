    ...
    >
      ...
      <a-row>
        <a-col :span="24" :style="{ textAlign: 'right' }">
          <a-button type="primary" html-type="submit" :loading="loading" @click="searchClick"> 查询
          </a-button>
      ...
      searchClick() {
        ...
        this.uColumns.forEach((item) => {
          ...
          if (item.formType == 'datePicker' && formTemp[item.dataIndex]) {
            ...
            formTemp[item.dataIndex + 'Start'] =  this.form[item.dataIndex][0].format('YYYY-MM-DD HH:mm:ss')
            formTemp[item.dataIndex + 'End'] = this.form[item.dataIndex][1].format('YYYY-MM-DD HH:mm:ss')
