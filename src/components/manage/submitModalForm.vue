<template>
    <div class="submit-form">
        ...
        <a-form-model v-if="mode === 'formModel'" :ref="formRef" :model="model" :rules="rules" :label-col="labelCol"
            :wrapper-col="wrapperCol">
            <a-form-model-item v-for="(submitFormItem, index) in uSubmitFormList" :key="index" has-feedback
                :label="submitFormItem.label" :prop="submitFormItem.prop">
                <FormItem v-model="model[submitFormItem.prop]" :formType="submitFormItem.formType"
                    :props="submitFormItem.props" />
            </a-form-model-item>
        </a-form-model>

        <!-- 也可以使用ant-design-vue的a-form -->
        <a-form v-if="mode === 'form'">
