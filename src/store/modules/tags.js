export default {
  ...
  getters: {
    ...
    curTags: (state) => {
      state.curTags = !localStorage.getItem('curTags')
        ? []
        : JSON.parse(localStorage.getItem('curTags'));
    ...
    isTagsAlive: () => (name) => {
      let curTags = !localStorage.getItem('curTags')
        ? []
        : JSON.parse(localStorage.getItem('curTags'));
      return name == curTags.name;
    },
    openMenuKeys: (state) => {
      state.openMenuKeys = !localStorage.getItem('openMenuKeys')
        ? []
