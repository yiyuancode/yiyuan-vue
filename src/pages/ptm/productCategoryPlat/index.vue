<template>
  <div>
    ...
    <edit :columns="table.columns" :editConfigProps="editConfigProps" :editId="editId" :key="editId||Math.floor(new Date().getTime() / 1000)  "
          @ok="getData">
    </edit>
  </div>
</template>
<script>
  ...
  import {
    deleteProductCategoryPlat as deletePost,
    getProductCategoryPlatPageList as pageGet
