  ...
  <div>
    ...
    >
      ...
      <div slot="tenantId" slot-scope="{ text, record }" class="y-flex">
        <y-shop-select v-model="record.tenantId" isSpan />
      </div>

      <div slot="packageType" slot-scope="{ text, record }" class="y-flex">
        {{ enumsMap['packageType' + text] }}
      </div>

      <div slot="chargeType" slot-scope="{ text, record }" class="y-flex">
