<template>
  <div class="menu-form-container">
    ...
    >
      ...
      <a-form-model-item
        ref="parentId"
        :label="menuTypeLabelInfo.parentMenuLabel"
        prop="parentId"
      >
        <a-tree-select
      ...
      <div class="menu-form-item">
        <a-form-model-item
          ref="name"
          :label="menuTypeLabelInfo.menuNameLabel"
          prop="name"
          :label-col="{ span: 12 }"
          :wrapper-col="{ span: 12 }"
        >
        ...
        <a-form-model-item
          ref="icon"
          :label="menuTypeLabelInfo.menuIconLabel"
          prop="icon"
          :label-col="{ span: 12 }"
          :wrapper-col="{ span: 12 }"
        >
      ...
      >
        <a-input
          v-model="model.routeComponent"
          placeholder="路由对应组件路径"
        />
      </a-form-model-item>

      <span class="menu-form-title">
        <a-divider orientation="left"> 功能设置 </a-divider>
      </span>
      ...
      <template>
        ...
        <a-form-model-item
          v-else
          ref="status"
          :label="menuTypeLabelInfo.menuStautsLabel"
          prop="status"
        >
          <a-radio-group v-model="model.status">
            <a-radio-button
      ...
      >
        <a-button type="primary" @click="saveClickHandle"> 保存修改 </a-button>
      </a-form-model-item>
    </a-form-model>
  </div>
</template>
