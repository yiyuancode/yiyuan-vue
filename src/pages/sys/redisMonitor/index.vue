<template>
  <div id="data-view">
    <dv-full-screen-container>
      <dv-border-box-11 title="Redis监控面板" :titleWidth="300" style="height: auto;width: 100%;">
        <div style="width: 96%;height: auto;margin: 0 auto;margin-top:58px;">
          <a-row>
            <a-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
              <div class="gutter-box" style="height: 350px;">
                <LineAreaCharts ref="avgConnectedClients" :props="avgConnectedClients"/>
              </div>
            </a-col>
            <a-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
              <div class="gutter-box" style="height: 350px;">
                <LineAreaCharts ref="avgTotalCommandsProcessed" :props="avgTotalCommandsProcessed"/>
              </div>
            </a-col>
            <a-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
              <div class="gutter-box" style="height: 350px;">
            ...
            <a-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
              <div class="gutter-box" style="height: 350px;">
                <LineAreaCharts ref="avgTotalKeyCount" :props="avgTotalKeyCount"/>
              </div>
            </a-col>
    ...
    methods: {
      async geReidsMonitorQueryCount() {
        ...
        resp.forEach((item) => {
          ...
          vm.avgConnectedClients.xAxis[0].data.push(moment(item.time).format('HH:mm'))
          vm.$refs.avgConnectedClients.resetCharts();


          vm.avgTotalCommandsProcessed.series[0].data.push(item.avgTotalCommandsProcessed);
          vm.avgTotalCommandsProcessed.xAxis = vm.avgConnectedClients.xAxis;
          vm.$refs.avgTotalCommandsProcessed.resetCharts();

          vm.avgUsedMemory.series[0].data.push((item.avgUsedMemory / 1000000).toFixed(2));
