<template>
  <div id="data-view">
    <dv-full-screen-container>
      <dv-border-box-11 title="服务器监控面板" :titleWidth="300" style="height: auto;width: 100%;">
        <div style="width: 96%;height: auto;margin: 0 auto;margin-top:58px;">
          <a-row>
            ...
            <a-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
              <div class="gutter-box" style="height: 350px;">
                <LineAreaCharts ref="totalNetworkUsage" :props="totalNetworkUsage"/>
              </div>
            </a-col>

            <a-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
              <div class="gutter-box" style="height: 350 px;">
                <LineAreaCharts ref="totalProcessCount" :props="totalProcessCount"/>
              </div>
            </a-col>
          </a-row>
        </div>
    ...
    methods: {
      async geHostMonitorQueryCount() {
        ...
        resp.forEach((item) => {
          ...
          vm.totalNetworkUsage.series[0].data.push((item.totalNetworkUsage / 1000000000).toFixed(0));
          vm.totalNetworkUsage.xAxis = vm.avgMemoryUsage.xAxis;
