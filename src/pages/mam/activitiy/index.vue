  ...
  <div>
    ...
    >
      ...
      <a-form-model-item slot="sex" slot-scope="{ form }" label="商品分类">
        ...
        <y-product-category-select-of-shop
          :key="form.tenantId"
...
export default {
  data() {
    return {
      category:
        '335c0770c41c9b77b03bb715232b7e3b,c76edf02d017f91c43d682da2ab8bbe1,bd275208-7739-11ee-9987-0242ac120002,bd2751d5-7739-11ee-9987-0242ac120002,bd2751d9-7739-11ee-9987-0242ac120002,bd2743a5-7739-11ee-9987-0242ac120002,bd274392-7739-11ee-9987-0242ac120002',
