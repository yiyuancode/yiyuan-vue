<template>
  <div>
    ...
    <y-search :columns="table.columns"
              :scopedSlots="3"
              :loading="table.loading"
              @search="search"
    >
      <a-form-model-item slot="scopedSlots-0" slot-scope="{form}" label="姓名">
        <a-input v-model="form.name"/>
      </a-form-model-item>
      <a-form-model-item slot="scopedSlots-1" slot-scope="{form}" label="手机">
        <a-input v-model="form.phone"/>
      </a-form-model-item>
      <a-form-model-item slot="scopedSlots-2" slot-scope="{form}" label="性别">
